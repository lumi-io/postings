  ...
  return (
    <CardBorder>
      <Card>
        ...
        <CustomCardActions>
          <Button size="small" onClick={() => window.location.href = "/admin/listing/" + props.id}>
            Edit
        </Button>
          <Button size="small" onClick={() => window.location.href = "/admin/listing/" + props.id + "/applicant"}>
            View Applicants
        </Button>
          <Button size="small" onClick={deleteListing}>
            Delete
        </Button>
        </CustomCardActions>
      </Card>
